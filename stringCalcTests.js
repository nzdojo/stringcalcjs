...
describe("String Calculator Tests", function () {
    ...
    it("'-1' + '1' returns '0' - checking addition of a negative number and a positive number", function (done) {
    ...
    it("Adding two very large numbers, one number is negative of the other and therefore the result is zero", function (done) {
        ...
        exerciseAndVerify(extremelyLargeNumber, '-' + extremelyLargeNumber, '0');
        done();
    });
    
    it("Adding one very large number and a small number", function (done) {
        var extremelyLargeNumber = '';
        var expectedResult = '';
        exerciseAndVerify(extremelyLargeNumber, '-1', expectedResult);
        done();
    });
